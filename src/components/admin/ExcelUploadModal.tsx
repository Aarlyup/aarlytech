...
const categoryTemplates: Record<string, any> = {
  'angel-investors': {
    ...
    ticketSize: '500000',
    fundSizeDescription: 'Typical check sizes and sectors',
    currency: 'INR',
  ...
  'micro-vcs': {
    ...
    fundSize: '5000000',
    fundSizeDescription: 'Deploys across seed and pre-seed over 2 years',
    fundSizeCurrency: 'INR',
    checkSize: '250000',
  ...
  'incubators': {
    ...
    fundSizeDescription: 'Supports startups with non-dilutive grants and equity',
  ...
  'accelerators': {
    ...
    fundSizeDescription: 'Standard accelerator funding with demo day support',
  ...
  'govt-grants': {
    ...
    sector: 'Open',
    grantSize: '1000000',
    fundSizeDescription: 'Typically awarded as milestone-based tranches',
    currency: 'INR',
    equityDilution: 'None',
